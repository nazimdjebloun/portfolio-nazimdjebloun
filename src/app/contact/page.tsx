...
export default function ContactPage() {
  ...
  return (
    <div className="py-20 md:py-40 min-h-screen bg-gradient-to-b from-background to-background/80 px-4 sm:px-6 lg:px-8">
      <div className="max-w-6xl mx-auto flex flex-col justify-center items-center">
        ...
        <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto py-5 text-center">
        ...
        <div className="flex gap-8 md:gap-20 flex-wrap w-full justify-center items-center">
          <Card className="bg-secondary p-5 border-zinc-300 border dark:border-borderaccent w-full max-w-[350px] h-[200px]">
